...
export default function Login() {
  ...
  const { login, loginWithGooglePopup, resetPassword, authError, setAuthError, currentUser, loading: authLoading } = useAuth(); // Destructure currentUser and authLoading
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        {!showResetForm ? (
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={locLoading || authLoading}
          ...
          <form onSubmit={handlePasswordReset} className="space-y-6">
            ...
            <div>
              <button
                ...
                className="btn btn-primary w-full"
              >
                {locLoading ? 'Sending...' : 'Send reset email'}
              </button>
            </div>
        ...
        {/* Google Sign-in - Only show in login mode */}
        {!showResetForm && (
          <div className="mt-6">
        ...
        {/* Register link - Only show in login mode */}
        {!showResetForm && (
